...
def celeb_data( celeb,no):
    """print formated data"""
    if no=='a':
        print(f"Compare {no}:{celeb['name']}, a {celeb['description']}, from {celeb['country']}")
    else:
        print(f"Against {no}:{celeb['name']}, a {celeb['description']}, from {celeb['country']}")

def compare(celeba, celebb,choice):
    """compare followers and return one with more followers"""
    global score
...
def game():
    ...
    while(1):
        ...
        celeba=compare(celeba,celebb,choice)
